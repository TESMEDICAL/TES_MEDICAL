    ...
    public partial class update1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__PhieuKha__2725E7FD9C84A3CD", x => x.MaPK);
                    table.ForeignKey(
                        name: "FK__PhieuKham__MaBN__286302EC",
                        column: x => x.MaBN,
                        principalTable: "BenhNhan",
                        principalColumn: "MaBN",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK__PhieuKham__MaBS__276EDEB3",
                        column: x => x.MaBS,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__HoaDon__835ED13B05CA61BC", x => x.MaHoaDon);
                    table.ForeignKey(
                        name: "FK__HoaDon__MaNV__32E0915F",
                        column: x => x.MaNV,
                        principalTable: "NhanVienYte",
                        principalColumn: "MaNV",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK__HoaDon__MaPK__31EC6D26",
                        column: x => x.MaPK,
                        principalTable: "PhieuKham",
                        principalColumn: "MaPK",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__HoaDonTh__2725E7FD25012CDB", x => x.MaPK);
                    table.ForeignKey(
                        name: "FK__HoaDonThuo__MaNV__403A8C7D",
                        column: x => x.MaNV,
                        principalTable: "NhanVienYte",
                        principalColumn: "MaNV",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK__HoaDonThuo__MaPK__3F466844",
                        column: x => x.MaPK,
                        principalTable: "ToaThuoc",
                        principalColumn: "MaPhieuKham",
                        onDelete: ReferentialAction.Restrict);
